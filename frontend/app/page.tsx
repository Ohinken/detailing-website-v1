...
if (!email.trim()) {
  ...
  <div className="fixed inset-x-0 top-0 z-[60] h-12 flex items-center justify-center bg-cyan-400 px-6 text-sm font-bold uppercase tracking-[0.18em] text-black">
  50% Off For First-Time Customers
</div>
  <header className="fixed inset-x-0 top-12 z-50 w-full border-b border-white/10 bg-black">
...
<div className="flex flex-col leading-none">
  ...
  <span className="mt-1 text-sm font-medium uppercase tracking-[0.35em] text-cyan-400">
    ...
    <section className="relative flex min-h-screen items-center justify-center px-6 pt-30">
            ...
            {activeServices.map((service) => (
              ...
              >
                <div className="mb-4 flex items-start justify-between gap-3">
                  <h3 className="max-w-[70%] text-3xl font-bold leading-tight min-h-[72px] flex items-start">
                    {service.title}
                  </h3>
                ...
                <ul className="space-y-4 text-gray-800">
                  {service.features.map((feature) => (
                    <li key={feature} className="flex items-start gap-3">
                      <span className="mt-1 text-lg font-bold text-cyan-500">
                        ✓
                      </span>
